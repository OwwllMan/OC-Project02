    ...
    */
    ...
    function send_email_agent(){
        if (isset($_REQUEST) && $_REQUEST != '') {
            ...
            $client_phone = (isset($_REQUEST['client_phone'])) ? $_REQUEST['client_phone'] : '' ;
            // Additional Emails
    ...
    function menu_pages(){
        ...
        add_submenu_page( 'edit.php?post_type=rem_property', 'Real Estate Manager - Custom Fields', __( 'Property Fields', 'real-estate-manager' ).' '. __( '(Pro)', 'real-estate-manager' ), 'manage_options', 'rem_custom_fields', array($this, 'render_custom_fields_page') );
        add_submenu_page( 'edit.php?post_type=rem_property', 'Real Estate Manager - Agent Fields', __( 'Registration Fields', 'real-estate-manager' ).' '. __( '(Pro)', 'real-estate-manager' ), 'manage_options', 'rem_agent_registration', array($this, 'render_agent_fields_page') );
    ...
    function single_property_fields(){
        ...
        if ($saved_fields != '' && is_array($saved_fields)) {
            ...
            $inputFields = rem_check_deprecated_fields($saved_fields, $inputFields);
        } else {
            include REM_PATH.'/inc/arrays/property-fields.php';
        }
